          ...
          doneContent={
            <div className="space-y-1">
              ...
              {installed.length < runtimes.length && (
                <button onClick={() => onNavigate('settings')} className="mt-1.5 inline-flex min-h-6 items-center text-2xs text-primary/70 underline hover:text-primary">
        ...
        <StepCard
          ...
          doneContent={
            <>
              ...
              <button
                className="inline-flex min-h-6 items-center text-2xs text-muted-foreground hover:text-foreground"
